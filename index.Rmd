...
<br>
<br>
```{r, echo=FALSE, fig.align='center', out.width='40%', fig.cap='Harrison York holding a hatchling Desert Tortoise'}
...
<br>
<br>
```{r, echo=FALSE, fig.align='center', out.width='65%', fig.cap='Adult *G. agassizii*'}
